...
class Quiz2ViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        databaseHandle = ref?.child("users").child(uid!).observe(.value, with: { (snapshot) in
            ...
            if Quiz2ViewController.check2 == 1
            {
    ...
    func times()
    {
        ...
        else if KalamQuiz1ViewController.time == 1.5
        {
            if score > 4
            {
                ...
                KalamQuiz1ViewController.time = 4.0
                Quiz2ViewController.check2 = 1
    ...
    override func viewDidDisappear(_ animated: Bool)
    {
        ...
        else if KalamQuiz1ViewController.time == 4.0
        {
            KalamQuiz1ViewController.time = 4.0
        }
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionFive" : Quiz2ViewController.check2])
