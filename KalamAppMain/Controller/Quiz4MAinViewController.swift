...
class Quiz4MAinViewController: UIViewController {
    ...
    let allQuestions = QuestionBank33()
    var questionNumber: Int = 0
    var score: Int = 0
    var selectedAnswer: Int = 0
     static var time = Double()
    
    static var check44 : Int = 0
    ...
    override func viewDidLoad() {
        ...
        if Quiz4MAinViewController.check44 == 1
        {
    ...
    func times()
    {
        ...
        if KalamQuiz1ViewController.time ==  0
        {
            if score > 1
            {
                ...
                Quiz4MAinViewController.check44 = 1
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionNine" : Quiz4MAinViewController.check44 ])
