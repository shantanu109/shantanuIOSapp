//
//  KalamQuiz2ViewController.swift
//  KalamAppMain
//
...
class KalamQuiz2ViewController: UIViewController
{
    ...
    let allQuestions = QuestionBank8()
    var questionNumber: Int = 0
    var score: Int = 0
    var selectedAnswer: Int = 0
    
   static var time = Double()
    static var checksection2 : Int = 0
    ...
    override func viewDidLoad() {
        ...
        if KalamQuiz2ViewController.checksection2 == 1
        {
    ...
    func times()
    {
        ...
        if KalamQuiz1ViewController.time ==  0
        {
            if score > 4
            {
                ...
                KalamQuiz2ViewController.checksection2 = 1
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionTwo" : KalamQuiz2ViewController.checksection2])
