...
class Quiz4ViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        if Quiz4ViewController.check4 == 1
        {
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionEight" : Quiz4ViewController.check4])
