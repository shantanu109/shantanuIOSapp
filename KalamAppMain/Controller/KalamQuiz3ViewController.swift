//
//  KalamQuiz3ViewController.swift
//  KalamAppMain
//
...
class KalamQuiz3ViewController: UIViewController
{
    ...
    let allQuestions = QuestionBank9()
    ...
    static var checksection3 : Int = 0
    ...
    override func viewDidLoad() {
        ...
        if KalamQuiz3ViewController.checksection3 == 1
        {
    ...
    func times()
    {
        ...
        if KalamQuiz1ViewController.time ==  0
        {
            if score > 4
            {
                ...
                KalamQuiz3ViewController.checksection3 = 1
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionThree" : KalamQuiz3ViewController.checksection3])
