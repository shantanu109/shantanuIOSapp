...
class Quiz6ViewController: UIViewController
{
    ...
    let allQuestions = QuestionBank55()
    ...
    override func viewDidLoad() {
        ...
        if Quiz6ViewController.check6 == 1
        {
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionTwelve" : Quiz6ViewController.check6])
