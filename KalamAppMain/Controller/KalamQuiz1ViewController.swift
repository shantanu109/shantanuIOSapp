//
//  KalamQuiz1ViewController.swift
//  KalamAppMain
//
...
class KalamQuiz1ViewController: UIViewController 
{
    ...
    let allQuestions = QuestionBank7()
    var questionNumber: Int = 0
    var score: Int = 0
    var selectedAnswer: Int = 0
    static var time = Double()
   
    static var checksection1 = Int()
    ...
    override func viewDidLoad() {
        ...
        if KalamQuiz1ViewController.checksection1 == 1
        {
    ...
    func times()
    {
        ...
        if score > 4
        {
         ...
         KalamQuiz1ViewController.checksection1 = 1
   ...
   else
  {
    ...
    KalamQuiz1ViewController.time = 3
        ...
        else if KalamQuiz1ViewController.time == 5.25
        {
            if score > 4
            {
                ...
                KalamQuiz1ViewController.time = 6.75
                KalamQuiz1ViewController.checksection1 = 1
        ...
        else if KalamQuiz1ViewController.time == 6.75
        {
            if score > 4
            {
                
                KalamQuiz1ViewController.time = 8.5
                KalamQuiz1ViewController.checksection1 = 1
       ...
       /* else if KalamQuiz1ViewController.time == 6.75
        {
            if score > 4
            {
                ...
                KalamQuiz1ViewController.time = 8.5
                KalamQuiz1ViewController.checksection1 = 1
                KalamQuiz1ViewController.TotalTime = KalamQuiz1ViewController.TotalTime + KalamQuiz1ViewController.time
    ...
    override func viewDidDisappear(_ animated: Bool)
    {
        ...
        else if KalamQuiz1ViewController.time == 4.5
     {
        ...
        else if KalamQuiz1ViewController.time == 7.5
        {
            KalamQuiz1ViewController.time = 7.5
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionOne" : KalamQuiz1ViewController.checksection1])
