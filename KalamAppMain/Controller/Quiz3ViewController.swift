...
class Quiz3ViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        if Quiz3ViewController.check3 == 1
        {
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionSix" : Quiz3ViewController.check3])
