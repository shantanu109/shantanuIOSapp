...
class Quiz55ViewController: UIViewController
{
    ...
    let allQuestions = QuestionBank44()
    ...
    override func viewDidLoad() {
        ...
        if Quiz55ViewController.check55 == 1
        {
    ...
    func times()
    {
        ...
        if KalamQuiz1ViewController.time ==  0
        {
            if score > 4
            {
                ...
                Quiz55ViewController.check55 = 1
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionEleven" : Quiz55ViewController.check55])
