...
class Quiz33ViewController: UIViewController {
    ...
    let allQuestions = QuestionBank22()
    var questionNumber: Int = 0
    var score: Int = 0
    var selectedAnswer: Int = 0
     static var time = Double()
    
    static var check33 : Int = 0
    ...
    override func viewDidLoad() {
        ...
        if Quiz33ViewController.check33 == 1
        {
    ...
    func times()
    {
        ...
        if KalamQuiz1ViewController.time ==  0
        {
            if score > 4
            {
                ...
                Quiz33ViewController.check33 = 1
        ...
        else if KalamQuiz1ViewController.time == 5.25
        {
            if score > 4
            {
                ...
                KalamQuiz1ViewController.time = 6
                Quiz33ViewController.check33 = 1
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionSeven" : Quiz33ViewController.check33])
