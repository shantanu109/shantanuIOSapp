...
class Quiz6MainViewController: UIViewController
{
    ...
    let allQuestions = QuestionBank6()
    var questionNumber: Int = 0
    var score: Int = 0
    var selectedAnswer: Int = 0
    
    static var time = Double()
    static var check66 = Int()
    ...
    override func viewDidLoad() {
        ...
        if Quiz6MainViewController.check66 == 1
        {
    ...
    func times()
    {
        ...
        if KalamQuiz1ViewController.time ==  0
        {
            if score > 4
            {
                ...
                Quiz6MainViewController.check66 = 1
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["SectionThirteen" : Quiz6MainViewController.check66])
