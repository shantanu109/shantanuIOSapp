...
class Quiz1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if Quiz1ViewController.check1 == 1
        {
    ...
    func updateDatabase()
    {
        ...
        ref?.child("users").child(uid!).updateChildValues(["Time Completed" : KalamQuiz1ViewController.time])
         ref?.child("users").child(uid!).updateChildValues(["SectionFour" : Quiz1ViewController.check1])
